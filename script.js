...
const filteerbtn = document.getElementById('filter')
...
function RenderItems(array) {
    ...
    array.forEach((element, index) => {
        container.innerHTML += `
        <div onclick="openModal(${index})" class="card">
        <div class="img">
...
filteerbtn.addEventListener('click', filter)
